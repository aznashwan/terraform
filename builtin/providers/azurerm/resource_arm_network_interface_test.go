...
func TestAccArmNetworkInterface(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				Config: testAccAzureRMNetworkInterface,
...
// testAccAzureRMNetworkInterface is the config tests will be conducted upon:
var testAccAzureRMNetworkInterface = `
...
# NOTE: resource "azurerm_instance" "test" ...
